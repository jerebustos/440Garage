...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-white text-slate-900 text-sm font-medium px-3 py-1 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap hidden md:block shadow-md">
        ¡Consultanos!
      </span>
    </a>
  );
